    ...
    <div className="min-h-screen relative page-transition">
      ...
      <main className="relative z-10 pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          <Link 
            to="/genres" 
            className="inline-flex items-center gap-2 text-primary hover:text-primary-glow transition-colors mb-8 animate-fade-in text-hover-simple"
          >
            <ArrowLeft size={20} />
          ...
          <div className="mt-16 text-center glass-card rounded-3xl p-12 border border-primary/20 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                ...
                <Heart className="transition-transform duration-300 group-hover:scale-110 relative z-10" size={20} />
