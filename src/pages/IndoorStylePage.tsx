import { ArrowLeft, Camera, Sparkles, Star, Users, Palette, Loader2 } from "lucide-react";
...
const IndoorStylePage = () => {
  const { images: indoorSources, isLoading, hasMore, initialLoad, setLoadMoreRef } = useImageGallery({
    folder: 'indoor',
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Artistic vision and styling guidance for unique results"
    },
    {
      icon: Users,
    ...
    },
    {
      ...
      description: "High-end fashion and editorial photography sessions"
    }
  ];
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-16">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-center mb-12">
              Portfolio <span className="bg-gradient-primary bg-clip-text text-transparent">Gallery</span>
            </h2>
            ...
            {!hasMore && !initialLoad && indoorSources.length > 0 && (
